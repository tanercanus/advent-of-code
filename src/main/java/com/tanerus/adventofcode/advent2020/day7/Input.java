...
public class Input {
    public static String[] initializeString() {
        String[] strings = {
                /*"shiny gold bags contain 2 dark red bags, 3 taner bags.",
                "dark red bags contain 2 dark orange bags, 3 taner bags.",
                "dark orange bags contain 2 dark yellow bags, 2 caner bags.",
                "dark yellow bags contain 2 dark green bags.",
                "dark green bags contain 2 dark blue bags.",
                "dark blue bags contain 2 dark violet bags.",
                "dark violet bags contain no other bags.",
                "taner bags contain no other bags.",
                "caner bags contain 2 taner bags."*/
